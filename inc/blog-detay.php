...
$query = $db->prepare("SELECT * FROM blog where sef=:sef LIMIT 1");
...
<main id="content" role="main">
    ...
    <div class="container">
        ...
        <div class="mb-10">
            <img src="upload/<?php echo $icsayfa['img']; ?>" style="max-width: 50%;border:1px solid #ddd;padding:5px;border-radius: 10px;"><br><br>
