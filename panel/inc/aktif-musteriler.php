...
if($_POST){
	...
	if(isset($_POST['id'])){
		foreach ($_POST['id'] as $id) {
        	...
        	$islem = $islem->execute(array(0,$id));
		}
		if($islem){
	        echo b();
	    }else{
...
<div class="page-header">
	<div class="page-leftheader">
		<h4 class="page-title">Kullanıcıları Pasif Et</h4>
	</div>
</div>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="order-table">
								...
								<table id="example1" class="table table-striped table-bordered text-nowrap  mb-0">
									...
									<tbody>
										<?php
					                      ...
					                      $query = $db->query("SELECT * FROM kullanici WHERE aktif = 1", PDO::FETCH_ASSOC);
							...
							<br>
							<button type="submit" class="btn btn-success pull-right">Pasif Et</button>
							</form>
						</div>
					</div>
				</div>
